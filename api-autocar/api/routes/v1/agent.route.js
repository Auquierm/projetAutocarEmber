...
router
    .route('/')
        .get(
            // authorize(ADMIN), 
            Validate(listAgents), AgentController.findAll)
...
router
    .route('/:agentId')
        .get(
            // authorize(ADMIN),
             Validate(getAgent), AgentController.findOne)
        .patch(
            // authorize(ADMIN), 
            Validate(updateAgent), AgentController.update)
        .delete(
            // authorize(ADMIN),
             Validate(removeAgent), AgentController.remove);
